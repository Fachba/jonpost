...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'jononlinecom@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Jon Online'; // Isikan dengan nama pengirim
    protected $password = 'spain7927'; // Isikan dengan password email pengirim
    ...
    public function send($email){
        ...
        $mail->Subject = 'Konfirmasi Akun Jononline';
        $mail->Body = 'Aktifkan';
